...
"flight fleer"	in-bight-bier rule	false	54	fear-to-fight rule	not-gaol rule	"You need to get less scared, not more. Plus, there's nowhere to run, anyway."
...
"(tolled|told) tail"	in-gold-gaol rule	false	101	--	--	"That must be very close indeed."
